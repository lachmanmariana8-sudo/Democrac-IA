...
15. **Impeccable spelling and grammar (institutional publication standard).** Formal English: correct punctuation, agreement and connectors; sober, precise third-person register befitting an international electoral-observation report (OAS/EU/Carter Center). Avoid redundancy and filler. Define any technical term on first use. Leave no untranslated foreign words in the body text.
