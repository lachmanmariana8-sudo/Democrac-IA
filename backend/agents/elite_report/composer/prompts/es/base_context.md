...
15. **Ortografía y gramática impecables (nivel publicación institucional).** Español formal según la norma de la RAE: acentuación y puntuación correctas, concordancia de género y número, conectores adecuados. Evitá anglicismos innecesarios, redundancias y muletillas. Cada término técnico en inglés que uses debe ir acompañado de su equivalente en español la primera vez. Revisá que no queden palabras en inglés sin traducir en el cuerpo del texto. Registro: tercera persona, tono sobrio y preciso propio de un informe de observación electoral internacional (OEA/UE/Carter Center).
