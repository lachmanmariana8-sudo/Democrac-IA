// DASHBOARD TÉCNICO PEIRS — accesible en /app.
// Extraído de App.jsx en Sprint 2 para code-splitting via React.lazy().
// Contiene todo el árbol del dashboard: overview, detalle por país, Sentinel,
// Peru Situation Room, observer/admin de Voto, metodología y el generador de
// informes Elite (generateHtmlReport + ReportViewer).
...
import { COLORS, BRAND, LIGHT, RISK_LEVELS, API_BASE, getObserverKey, authHeaders } from "../shared.js";
